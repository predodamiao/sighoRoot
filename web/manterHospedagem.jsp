...
<head>
    ...
    <body>
        ...
        <form>    
        <table>
            <tr><td><label for="dataChegada">Chegada:</label> </td><td><input type="date" name="dataChegada" id="dataChegada" value="$hospedagem.dataChegada"></td></tr>
            <tr><td><label for="dataSaida">Saída</label> </td><td><input type="date" name="dataSaida" id="dataSaida" value="$hospedagem.dataSaida"></td></tr>
            <tr><td><label for="dataEstimadaChegada">Chegada:</label> </td><td><input type="date" name="dataEstimadaChegada" id="dataEstimadaChegada" value="$hospedagem.dataEstimadaChegada"></td></tr>
            <tr><td><label for="dataEstimadaSaida">Saída</label> </td><td><input type="date" name="dataEstimadaSaida" id="dataEstimadaSaida" value="$hospedagem.dataEstimadaSaida"></td></tr>
