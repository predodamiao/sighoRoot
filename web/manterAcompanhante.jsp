...
<html>
    ...
    <body>
        ...
        <form>    
        <table>
            <tr><td><label for="id">ID:</label> </td><td><input type="number" name="id" id="id" value="${acompanhante.id}"></td></tr>
            ...
            <tr><td><label for="ocupaCama">Ocupa Cama?</label></td><td><input type="checkbox" name="ocupaCama" id="ocupaCama"></td></tr>
